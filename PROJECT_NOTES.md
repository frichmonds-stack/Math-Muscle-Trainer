...
- 2026-05-18 `v0.20.6` visual reference system: added `docs/design/reference/` with a canonical button/control board, Home dark/light baseline screenshots, and a screenshot audit scaffold. Current process state: the button board and Home screenshots are wired in; Setup, Practice, Learn, Progress, and Options screenshots still need to be captured, and future briefs should cover Surface/Card UI, Learning Interaction UI, Progress/Evidence UI, and App Shell/Nav.
